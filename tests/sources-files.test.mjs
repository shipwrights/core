...
test("listAvailable filters by status", async () => {
  const dir = makeRepo();
  writeEpic(dir, "E-01-a.md", { id: "E-01", title: "A", status: "refined", priority: "P1", size: "small" });
  writeEpic(dir, "E-02-b.md", { id: "E-02", title: "B", status: "shipped", priority: "P0", size: "small" });
  writeEpic(dir, "E-03-c.md", { id: "E-03", title: "C", status: "idea", priority: "P2", size: "small" });
...
test("pickNext respects parents-shipped + priority + size", async () => {
  const dir = makeRepo();
  writeEpic(dir, "E-00-parent.md", { id: "E-00", title: "P", status: "shipped", priority: "P0", size: "small" });
  writeEpic(dir, "E-01-blocked.md", { id: "E-01", title: "A", status: "refined", priority: "P0", size: "small", parents: ["E-99"] });
  writeEpic(dir, "E-02-ready-low.md", { id: "E-02", title: "B", status: "refined", priority: "P3", size: "small", parents: ["E-00"] });
  writeEpic(dir, "E-03-ready-high.md", { id: "E-03", title: "C", status: "refined", priority: "P0", size: "medium", parents: ["E-00"] });
  writeEpic(dir, "E-04-ready-high-small.md", { id: "E-04", title: "D", status: "refined", priority: "P0", size: "small", parents: ["E-00"] });
  const src = createSource({ projectRoot: dir });
...
test("pickNext returns null when nothing ready", async () => {
  const dir = makeRepo();
  writeEpic(dir, "E-01.md", { id: "E-01", title: "A", status: "shipped", priority: "P0", size: "small" });
  writeEpic(dir, "E-02.md", { id: "E-02", title: "B", status: "refined", priority: "P0", size: "small", parents: ["E-99"] });
  const src = createSource({ projectRoot: dir });
  const next = await src.pickNext();
...
test("materialize creates a stub when missing", async () => {
  ...
  const r = await src.materialize(
    { id: "E-99", title: "New idea", priority: "P1", size: "small", domain: "frontend" },

...
test("slugifyTitle: lowercase + hyphenate + truncate", () => {
  assert.equal(slugifyTitle("Add Forgot-Password Flow!"), "add-forgot-password-flow");
...
`;
  ...
  const plan = readPlan({ projectRoot: dir, outputDir: "docs/backlog/specs", id: "S-2026-05-12-test" });
...
x
`;
  writePlan({ projectRoot: dir, outputDir: "specs", id: "S-x", slug: "x", content });
  setStatus({ projectRoot: dir, outputDir: "specs", id: "S-x", status: "approved" });
